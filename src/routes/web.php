...
Route::get('/genre/update/{genre}', [GenreController::class, 'update']);
Route::post('/genre/patch/{genre}', [GenreController::class, 'patch']);
Route::post('/genre/delete/{genre}', [GenreController::class, 'delete']);
